...
- [R for Data Science](https://r4ds.hadley.nz/) -- For 331 review
- [Happy Git with R](https://happygitwithr.com/) -- For getting set-up with
version control
- [Quarto tutorials](https://quarto.org/docs/get-started/authoring/rstudio.html) -- 
To get familiar with Quarto
- Quarto Dashboards
- WebR
...
- [usethis](https://usethis.r-lib.org/) -- For pull requests
...
- Create complex and reproducible data reports, that include interactive 
