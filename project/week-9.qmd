...
Since these functions are meant to be shortcuts for code you already wrote in previous units, you can begin by simply copying that code into the function body. Then, you'll need to *generalize* the function for different inputs and outputs.
