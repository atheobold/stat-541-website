---
title: "Project Checkpoint 2 - Example"
format: html
execute:
  message: false
  warning: false
...
#| echo: false
#| eval: false
#| label: allison-code-approach

olympics |>
  # I don't like using sex == "F" inside a summarize, I would prefer to add a 
  # group and count
  group_by(year, games, team, sex) |>
  count() |> 
  ungroup() |> 
  pivot_wider(names_from = sex, 
              ...
              names_prefix = "count_") |> 
  mutate(
    prop_F = count_F/(count_F + count_M)
  )
```
...
-   Think about how to handle anomalies in the country team names, e.g. "USSR"
vs. "Russia".
