...
* Reference the package directly with `readr::read_csv` or use `@importFrom readr read_csv`

* Run `use_packages("readr")` to include the package as an imported dependency.
