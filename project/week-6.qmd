...
- Create a `leaflet` map visualizing information from your original dataset
(from Project 1).
- This map should be thoughtfully integrated into the existing structure of
your dashboard. 
...
- The leaflet map you make should address the research question you choose!
...
The content in your dashboard should be organized in a way that is easy for
the reader to view. 
...
- Sufficient space should be given to the tabsets, so their titles appear
horizontally. 
...
- The colors on the plot should coordinate with the colors of the dashboard 
theme.
