...
U.S. state capitals. Organize all of this information into a nice data frame
(or data frame-like object) that will be easy to use for mapping.

### Mapping the Data

2. Map the U.S. state capitals using `leaflet`.

3. Find an image of your choosing to use as the marker icon, that's relevant for
these data. Maybe a spaceship? 🚀 Or an astronaut? 🧑‍🚀
