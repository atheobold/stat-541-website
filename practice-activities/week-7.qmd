...
<a href="student/pa-7.zip" download>`pa-7.zip`</a>

This `.zip` folder contains:

1. the Quarto file (`pa-7.qmd`)
2. the source file for creating the interactive dashboard 
(`morro-bay-estuary-dash.qmd`)

::: {.callout-important}
Be sure to save the files inside your Week 7 folder of your STAT 431 (or 541)
folder! 
:::
...
8. How are the plotting data adjusted based on the radio button that is 
selected?
