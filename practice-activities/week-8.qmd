...
<a href="student/test-newfunctions.R" download>Download this `.R` file</a> and then add it - without editing anything about it - to the `tests/testthat/` folder of the `regexcite` package.
