...
Although you can [learn how to use CSS Selectors by hand](%5BCSS%20Selectors%5D(https://css-tricks.com/how-css-selectors-work/)), we will use a shortcut by installing the [Selector Gadget](http://selectorgadget.com/) tool.
...
req_vid("Selector Gadget Tutorial Video", url = 'http://selectorgadget.com/', 
        embed = '<iframe width="400" height="225" style="width: 400px; height: 225px;" src="http://selectorgadget.com/" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')
```

```{r, results = "asis", echo = FALSE}
checkin("Selector Gadget")
```
...
2.  What CSS selector would you use to obtain the publication date of each article?

<!-- .date-display-single -->

3.  What CSS selector would you use to obtain the article abstract paragraph (which will also include the publication date)?
